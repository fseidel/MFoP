...
MFoP (Mod Files on Pizza) is a portable Amiga Mod player written in C. It is designed to be fast, small (Mac binary is under 32KiB!), lightweight, and portable.
